namespace CoffeeMachine.Wpf.ViewModels
{
    ...
    public class ShellViewModel : BindableBase
	{
		...
		public ShellViewModel()
		{
            ...
            CoffeeMachine.OnTransitioned(this.OnTransitionAction);
            InsertCoinCommand = this.CoffeeMachine.CreateCommand(CoffeeMachineTrigger.InsertMoney,
                (double? param) =>
                {
            ...
            RefundMoneyCommand = CoffeeMachine.CreateCommand(CoffeeMachineTrigger.RefundMoney, null, null);
            PrepareCoffeeCommand = CoffeeMachine.CreateCommand(CoffeeMachineTrigger.PrepareCoffee, null, null);
            TakeCoffeeCommand = CoffeeMachine.CreateCommand(CoffeeMachineTrigger.TakeCoffe, null, null);
            CoffeeMachine.PropertyChanged += this.CoffeeMachineOnPropertyChanged;
        }
